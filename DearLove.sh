...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  Assembly696   "$i"                    "
echo $i""$pu"  WhatsApp:  085242xxxxx"$i"                "
echo $i""$pu"  GMAIL   :  apaanbro11@gmail.com"$i"     "
echo $i""$pu"  GC.     :  GOLDEN OFFICIAL CYBER"$i"                  ""
echo $i""$pu"  YOUTUBE :  Monster Legends"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Kepoooi"
echo $ku"YouTube  :"$i" MONSTER LEGENDS"
echo $ku"WhatsApp :"$i" 085242xxxxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { MONTER LEGEND }"
echo $pur"Thanks To Asb,GOC,WCA,MCI"
echo $pur"Spesial Thanks For Jr.Fake,Mr.C3BONG,Mr-SI,Mr.CsT,44LAFANZER,rdrptpa,Kaneki"
exit
fi
